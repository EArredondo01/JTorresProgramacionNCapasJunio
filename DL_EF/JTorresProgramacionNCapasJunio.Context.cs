...
namespace DL_EF
{
    ...
    public partial class JTorresProgramacionNCapasJunioEntities : DbContext
    {
        public JTorresProgramacionNCapasJunioEntities()
            : base("name=JTorresProgramacionNCapasJunioEntities")
        {
        }
